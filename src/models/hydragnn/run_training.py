...
import os, json
import sys
# Get the absolute path of your 'hydragnn' folder
hydragnn_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))

# Add it to Python's search path (sys.path)
if hydragnn_path not in sys.path:
    sys.path.insert(0, hydragnn_path)
